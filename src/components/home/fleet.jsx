...
const cars = [
  { id: 1, name: "Innova Crysta", type: "LUXURY MPV", img: "car1.webp", rate: "18", seats: "7+1", ac: "Dual Chill", fuel: "Diesel" },
  { id: 2, name: "Hyundai Aura", type: "PREMIUM SEDAN", img: "car2.webp", rate: "12", seats: "4+1", ac: "Climate", fuel: "CNG/Petrol" },
  { id: 3, name: "Maruti Swift", type: "ECONOMY HATCH", img: "car3.webp", rate: "10", seats: "4+1", ac: "Manual", fuel: "Petrol" },
  { id: 4, name: "Mahindra Scorpio", type: "POWER SUV", img: "car4.webp", rate: "16", seats: "6+1", ac: "Powerful", fuel: "Diesel" },
  { id: 5, name: "Hyundai i10", type: "CITY COMPACT", img: "car5.webp", rate: "9", seats: "4+1", ac: "Standard", fuel: "Petrol" },
  { id: 6, name: "Mahindra Bolero", type: "RUGGED MUV", img: "car6.webp", rate: "13", seats: "6+1", ac: "Powerful", fuel: "Diesel" },
];

const Fleet = () => {
  return (
    <section className="bg-black py-12 md:py-20 overflow-hidden">
      {/* Hidden Scrollbar Styles Injection */}
